                        ...
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select name="active" id="active" class="form-control select2" style="width: 100%">
                                        <option value=0>{{ __('gennix.no') }}</option>
                                        <option value=1>{{ __('gennix.yes') }}</option>
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group {{ $errors->has('position') ? 'has-error' : '' }} col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="position" name="position" value="{{ old('position') ? old('position') : '' }}">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="gender" id="gender" class="form-control select2" style="width: 100%">
                                        <option value='M'>{{ __('gennix.model_user.details_gender_male') }}</option>
                                        <option value='F'>{{ __('gennix.model_user.details_gender_femme') }}</option>
                                        <option value='N'>{{ __('gennix.model_user.details_gender_undefined') }}</option>
                                    </select>
